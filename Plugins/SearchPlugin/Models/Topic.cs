...
public sealed class Topic(IRecordController recordController) : TextSearcher<ISkyrimMod, ISkyrimModGetter, IDialogTopic, IDialogTopicGetter>(recordController) {
