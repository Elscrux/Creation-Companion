...
public interface IRecordListFactory {
    ...
    IRecordListVM FromIdentifiers(IEnumerable<IFormLinkIdentifier> identifiers, IRecordBrowserSettings? browserSettings = null);
    ...
    IRecordListVM FromType(Type type, IRecordBrowserSettings? browserSettings = null);
}
