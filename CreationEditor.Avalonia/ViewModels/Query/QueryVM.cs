...
public sealed class QueryVM(
    ...
    public ReactiveCommand<ReflectionQueryField, Unit> SelectField { get; }
        = ReactiveCommand.Create<ReflectionQueryField>(childField => {
            queryRunner.FieldSelector.SelectedField = childField;
        });
}
