...
public class DoubleTappedBehavior : AvaloniaObject {
    ...
    public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<DoubleTappedBehavior, Interactive, ICommand>("Command");
    ...
    public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<DoubleTappedBehavior, Interactive, object>("CommandParameter");
