...
public sealed class LogLevelToBrushConverter : AvaloniaObject, IValueConverter {
    public static readonly StyledProperty<IBrush?> VerboseBrushProperty =
        AvaloniaProperty.Register<LogLevelToBrushConverter, IBrush?>(nameof(VerboseBrush));
    ...
    public static readonly StyledProperty<IBrush?> MessageBrushProperty
        = AvaloniaProperty.Register<LogLevelToBrushConverter, IBrush?>(nameof(MessageBrush));
    ...
    public static readonly StyledProperty<IBrush?> FatalBrushProperty =
        AvaloniaProperty.Register<LogLevelToBrushConverter, IBrush?>(nameof(FatalBrush));
