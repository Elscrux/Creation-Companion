...
public static class ModExtension {
    extension(IModGetter mod) {
        ...
        public IEnumerable<ModKey> GetTransitiveMasters(IGameEnvironment gameEnvironment, bool includeSelf = false) {
        ...
        public IEnumerable<IReadOnlyList<IConditionGetter>> GetConditions() {
