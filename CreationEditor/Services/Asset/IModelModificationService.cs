...
public interface IModelModificationService {
    ...
    /// </summary>
    /// <param name="fileSystemLink">File system link to remap links for</param>
    ...
    void RemapLinks(FileSystemLink fileSystemLink, Func<string, bool> shouldReplaceLink, DataRelativePath newLink);
}
