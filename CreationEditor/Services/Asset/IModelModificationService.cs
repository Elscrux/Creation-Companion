...
public interface IModelModificationService {
    ...
    /// </summary>
    /// <param name="dataSourceLink">File system link to remap links for</param>
    ...
    void RemapLinks(DataSourceLink dataSourceLink, Func<string, bool> shouldReplaceLink, DataRelativePath newLink);
}
